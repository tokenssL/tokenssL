...
class SqlBuilder
{
	...
	public function importGroupConditions(self $builder)
	{
		if ($builder->having) {
	 ...
	 * @return bool
	 */
	protected function addCondition($condition, $params, array &$conditions, array &$conditionsParameters)
	{
	...
	public function setOrder($columns, $parameters)
	{
		$this->order = $columns;
	 ...
	 * @return string
	 */
	protected function buildQueryJoins($joins, $leftJoinConditions = [])
	{
		$return = '';
	 ...
	 * @return bool
	 */
	protected function addConditionComposition($columns, $parameters, array &$conditions, array &$conditionsParameters)
	{
