 ...
 * @method void char(int $font, $x, $y, $char, $color)
 * @method void charUp(int $font, $x, $y, $char, $color)
 ...
 * @method void convolution(array $matrix, $div, $offset)
 ...
 * @method Image cropAuto(int $mode = -1, $threshold = .5, $color = -1)
 ...
 * @method array ftText($size, $angle, $x, $y, $col, $fontFile, $text, $extrainfo = null)
 * @method void gammaCorrect(float $inputgamma, $outputgamma)
 ...
 * @method array psText(string $text, $font, $size, $color, $backgroundColor, $x, $y, $space = null, $tightness = null, $angle = null, $antialiasSteps = null)
 * @method void rectangle($x1, $y1, $x2, $y2, $col)
 * @method Image rotate(float $angle, $backgroundColor)
 * @method void saveAlpha(bool $saveflag)
 * @method Image scale(int $newWidth, $newHeight = -1, $mode = IMG_BILINEAR_FIXED)
 ...
 * @method void string($font, $x, $y, $s, $col)
 * @method void stringUp($font, $x, $y, $s, $col)
 * @method void trueColorToPalette(bool $dither, $ncolors)
 * @method array ttfText($size, $angle, $x, $y, $color, $fontfile, $text)
