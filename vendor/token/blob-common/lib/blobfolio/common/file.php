...
class file
{
	 ...
	 */
	public static function csv_headers($csv, $cols = false, $delimiter = ',')
	{
	 ...
	 */
	public static function data_uri($path, $constringent = false)
	{
	 ...
	 * @return string Path.
	 */
	public static function leadingslash($path, $constringent = false)
	{
	 ...
	 * @return int Lines.
	 */
	public static function line_count($file, $trim = true)
	{
		// We definitely need a file.
	 ...
	 * @return string Path.
	 */
	public static function path($path, $validate = true, $constringent = false)
	{
	 ...
	 * @return array Path(s).
	 */
	public static function scandir($path, $show_files = true, $show_dirs = true, $depth = -1)
	{
		ref\file::path($path, true);
	 ...
	 * @return string Path.
	 */
	public static function trailingslash($path, $constringent = false)
	{
	 ...
	 * @return string Path.
	 */
	public static function unixslash($path, $constringent = false)
	{
	 ...
	 * @return string Path.
	 */
	public static function unleadingslash($path, $constringent = false)
	{
	 ...
	 * @return string Path.
	 */
	public static function untrailingslash($path, $constringent = false)
	{
