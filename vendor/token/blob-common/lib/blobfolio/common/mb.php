...
class mb
{
	 ...
	 */
	public static function str_pad($str = '', $pad_length = 0, $pad_string = ' ', $pad_type = STR_PAD_RIGHT, $constringent = false)
	{
	 ...
	 */
	public static function str_split($str, $split_length = 1, $constringent = false)
	{
	 ...
	 */
	public static function strlen($str, $constringent = false)
	{
	 ...
	 */
	public static function strrev($str, $constringent = false)
	{
	 ...
	 */
	public static function strtolower($str = '', $strict = false, $constringent = false)
	{
	 ...
	 * @return string String.
	 */
	public static function strtoupper($str = '', $strict = false, $constringent = false)
	{
	 ...
	 * @return string String.
	 */
	public static function substr($str, $start = 0, $length = null, $constringent = false)
	{
		ref\cast::constringent($str, $constringent);
	 ...
	 * @return bool True.
	 */
	public static function trim($str = '', $constringent = false)
	{
	 ...
	 * @return string String.
	 */
	public static function ucfirst($str = '', $strict = false, $constringent = false)
	{
	 ...
	 * @return string String.
	 */
	public static function ucwords($str = '', $strict = false, $constringent = false)
	{
