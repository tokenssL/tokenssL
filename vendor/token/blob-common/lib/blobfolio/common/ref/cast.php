...
class cast
{
	 ...
	 * @return bool True.
	 */
	public static function array2(&$value = null)
	{
		// Short circuit.
		if (is_array($value)) {
			return true;
	 ...
	 * @return bool True.
	 */
	public static function to_type(&$value, $type = '', $flatten = false)
	{
		if (!$type) {
			return true;
		}
	 ...
	 * @return bool True/false.
	 */
	public static function constringent(&$value = null, $light = false)
	{
