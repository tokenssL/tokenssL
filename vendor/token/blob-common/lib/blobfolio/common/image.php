...
class image
{
	 ...
	 */
	public static function svg_dimensions($svg, $constringent = false)
	{
	 ...
	 * @return bool True/false.
	 */
	public static function to_webp($from, $to = null, $cwebp = null, $gif2webp = null, $refresh = false)
	{
		// Try binaries first, fallback to GD.
		return (static::to_webp_binary($from, $to, $cwebp, $gif2webp, $refresh) ||
	 ...
	 * @return bool True/false.
	 */
	public static function to_webp_gd($from, $to = null, $refresh = false)
	{
	 ...
	 * @return bool True/false.
	 */
	public static function to_webp_binary($from, $to = null, $cwebp = null, $gif2webp = null, $refresh = false)
	{
		if (!static::to_webp_sources($from, $to)) {
			return false;
		}
