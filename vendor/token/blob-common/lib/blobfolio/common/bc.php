...
class bc
{
	...
	public static function bitwise($method, $left, $right = '0', $bits = null)
	{
		...
		$bitwise_operators = constants::BITWISE_OPERATORS;
		if (isset($bitwise_operators[$method])) {
			$method = $bitwise_operators[$method];
		}

		if (!$method || !in_array($method, $bitwise_operators, true)) {
			return '0';
		}
